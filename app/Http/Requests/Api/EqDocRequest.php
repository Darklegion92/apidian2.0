...
class EqDocRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'spd.*.subscriber_consumption.utility_meter' => 'nullable|array',
            'spd.*.subscriber_consumption.utility_meter.meter_number' => 'required_with:spd.*.subscriber_consumption.utility_meter|string',
            'spd.*.subscriber_consumption.utility_meter.previous_meter_reading_date' => 'required_with:spd.*.subscriber_consumption.utility_meter|date_format:Y-m-d',
            'spd.*.subscriber_consumption.utility_meter.previous_meter_quantity' => 'required_with:spd.*.subscriber_consumption.utility_meter|numeric',
            'spd.*.subscriber_consumption.utility_meter.latest_meter_reading_date' => 'required_with:spd.*.subscriber_consumption.utility_meter|date_format:Y-m-d',
            'spd.*.subscriber_consumption.utility_meter.latest_meter_quantity' => 'required_with:spd.*.subscriber_consumption.utility_meter|numeric',
            'spd.*.subscriber_consumption.utility_meter.meter_reading_method' => 'required_with:spd.*.subscriber_consumption.utility_meter|string',
            'spd.*.subscriber_consumption.utility_meter.duration_measure' => 'required_with:spd.*.subscriber_consumption.utility_meter|numeric',
